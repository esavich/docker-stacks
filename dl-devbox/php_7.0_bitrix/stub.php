<html>
	<head>
		<title>Установка Bitrix</title>
	</head>
	<body>
	<script>
		function GoToPage(url)
		{
			window.setTimeout('document.location="' + url + '"', 10000);
		}
		GoToPage(document.location.href);
	</script>
	<style>
		html, body {
			padding: 0 10px;
	...
	<div class="wrap ru">
		<header class="header">
			<a href="" target="_blank" class="buslogo-link"><span class="buslogo ru"></span></a>
		</header>
				...
				<table class="content-table">
					<tr>
						<td align=left style="/*font-size:14pt;color:#E11537;padding-left:25px*/">
							<h3 class="content-header" style="margin: 0;padding: 0;text-align: left;">Скачивание архива bitrix...</h3>
							<hr style="margin: 15px 0;">
						</td>
					</tr>
					<tr>
						<td style="font-size:10pt" valign="middle">В данный момент скачивается и распаковывается архив bitrix. Придется немного подождать.</td>
					</tr>
					<tr>
						<td style="font-size:10pt; padding-top: 20px" valign="middle" align="center" height="40px"><input type="button" value="&nbsp;&nbsp;&nbsp;Ждемс...&nbsp;&nbsp;&nbsp;" onclick="document.location.reload()"></td>
					</tr>
				</table>
